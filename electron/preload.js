...
const commands = new Set(['state', 'save', 'preview', 'start', 'pause', 'stop', 'license-import', 'license-check', 'license-device', 'image-select', 'window-list', 'capture-overlay-open', 'overlay-show', 'overlay-hide', 'macro-import', 'macro-export', 'overlay-rebind', 'overlay-auto', 'progress-toggle']);
