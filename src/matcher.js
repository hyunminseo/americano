...
function findBest(screen, template, width, height, templateWidth, templateHeight) {
...
async function findTemplate(screen, template, threshold) {
  ...
  const match = findBest(screen.data, template.data, screenWidth, screenHeight, templateWidth, templateHeight);
